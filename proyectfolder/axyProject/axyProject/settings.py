"""
Django settings for axyProject project.
...
SECRET_KEY = 'django-insecure-jxl=lkb_p@lshy73@pdf%uqnt8z2+elaz9pafm_(mgs5)$d(@3'
...
WSGI_APPLICATION = 'axyProject.wsgi.application'
